      ...
      <div className="flex">
        ...
        {ERAsegData.ERAsegData.codigoRespuesta === "01" ? (
          <div className="flex flex-col pl-2 w-[300px]">
            ...
            <div id="erasegname" className="text-[15px] text-[#1d1d1d]">
              {ERAsegData.ERAsegData.nombreEPS}
            </div>
            {ERAsegData.isAuthReady && (<div className="font-light text-[14px] text-[#6c6c6e]">{ERAsegData.authERAdata.ipsAsignada}</div>)}
          ...
          console.log("pobre no asegurado")
        ) : (
          "usuario pobre o del régimen especial"
        )}{" "}
        {/**---> Manejar la respuesta de pobre no asgurado o del régimen especial */}
        </div>
      </div>
    </>
  );
